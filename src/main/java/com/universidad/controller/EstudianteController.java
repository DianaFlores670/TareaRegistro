...
public class EstudianteController { // Define la clase EstudianteController
    ...
    @GetMapping("/inscripcion/{numeroInscripcion}") // Anotación que indica que este método maneja solicitudes GET con
    ...
    public ResponseEntity<EstudianteDTO> obtenerEstudiantePorNumeroInscripcion(
        ...
        EstudianteDTO estudiante = estudianteService.obtenerEstudiantePorNumeroInscripcion(numeroInscripcion); // Llama
                                                                                                               // al
                                                                                                               // servicio
                                                                                                               // para
                                                                                                               // obtener
                                                                                                               ...
                                                                                                               // estudiante
        long fin = System.currentTimeMillis();
        logger.info("[ESTUDIANTE] Fin obtenerEstudiantePorNumeroInscripcion: {} (Duracion: {} ms)", fin,
                (fin - inicio));
    ...
    public ResponseEntity<EstudianteDTO> crearEstudiante(@Valid @RequestBody EstudianteDTO estudianteDTO) { // Método
                                                                                                            // para
                                                                                                            // crear un
                                                                                                            // nuevo
                                                                                                            // estudiante
        EstudianteDTO nuevoEstudiante = estudianteService.crearEstudiante(estudianteDTO); // Llama al servicio para
                                                                                          // crear el estudiante
        return ResponseEntity.status(201).body(nuevoEstudiante); // Retorna una respuesta HTTP 201 Created con el nuevo
                                                                 // estudiante
    }

    @PutMapping("/{id}") // Anotación que indica que este método maneja solicitudes PUT con un parámetro
                         // de ruta
    @Transactional // Anotación que indica que este método debe ejecutarse dentro de una
                   // transacción
    ...
    public ResponseEntity<EstudianteDTO> actualizarEstudiante(
        ...
        EstudianteDTO estudianteActualizado = estudianteService.actualizarEstudiante(id, estudianteDTO); // Llama al
                                                                                                         // servicio
                                                                                                         // para
                                                                                                         // actualizar
                                                                                                         // el
                                                                                                         // estudiante
        return ResponseEntity.ok(estudianteActualizado); // Retorna una respuesta HTTP 200 OK con el estudiante
                                                         // actualizado
    }

    @PutMapping("/{id}/baja") // Anotación que indica que este método maneja solicitudes PUT para dar de baja
                              // un estudiante
    @Transactional // Anotación que indica que este método debe ejecutarse dentro de una
                   // transacción
    @ResponseStatus(HttpStatus.OK) // Anotación que indica que la respuesta HTTP debe tener un estado 200 OK
    public ResponseEntity<EstudianteDTO> eliminarEstudiante(
        ...
        EstudianteDTO estudianteEliminado = estudianteService.eliminarEstudiante(id, estudianteDTO); // Llama al
                                                                                                     // servicio para
                                                                                                     // eliminar el
                                                                                                     // estudiante
    ...
    @GetMapping("/activos") // Anotación que indica que este método maneja solicitudes GET a la ruta
                            // /activos
    public ResponseEntity<List<EstudianteDTO>> obtenerEstudianteActivo() { // Método para obtener una lista de
                                                                           // estudiantes activos
        List<EstudianteDTO> estudiantesActivos = estudianteService.obtenerEstudianteActivo(); // Llama al servicio para
                                                                                              // obtener los estudiantes
                                                                                              // activos
        return ResponseEntity.ok(estudiantesActivos); // Retorna una respuesta HTTP 200 OK con la lista de estudiantes
                                                      // activos
    }
